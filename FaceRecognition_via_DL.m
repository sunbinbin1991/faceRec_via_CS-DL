...
N = 256;                 %the dimension of each minor dictionary
L = 256;                 %the number of atoms(column) in each minor dictionary
BlockSize = 16;          %the size of the block you extracted from images: BlockSize*BlockSize
imgRow = 112;            %the row dimension of the face size
imgCol = 92;             %the column dimension of each face
faceLib = 'ORL_test';    %the face label used to train and test
